...
const getWeather = async (city) => {
    try {
        ...
        const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=a8fdb404c4ded7d1a81cadf0e84c6cf7`,
...
window.addEventListener("load", () => {
    ...
    if (navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition((position) => {
                ...
                const api = `${proxy}api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=a8fdb404c4ded7d1a81cadf0e84c6cf7 `
